...
class Config(BaseModel):
    ...
    def load(cls) -> "Config":
        ...
        if not config_path.exists():
            raise FileNotFoundError("Configuration file not found. Place config.yaml in config/ or ~/.book2skills/config/.")
    ...
    def find_config_file(cls, filename: str) -> Path | None:
        ...
        2) ~/.book2skills/config/{filename} in user home directory
        ...
        user_config = Path.home() / ".book2skills" / "config" / filename
